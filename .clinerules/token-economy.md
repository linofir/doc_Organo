...
- Read `Documentation/State.md` and `AGENTS.md` before large tasks.
- Treat `Documentation/State.md` as current operational truth when bootstrap docs are stale.
- Use `@` for specific files — avoid attaching entire `Legacy/` folders.
